...
class DIALModelProvider(OpenAICompatibleProvider):
    ...
    SUPPORTED_MODELS = {
        ...
        "anthropic.claude-opus-4.1-20250514-v1:0": ModelCapabilities(
            provider=ProviderType.DIAL,
            model_name="anthropic.claude-opus-4.1-20250514-v1:0",
        ...
        "anthropic.claude-opus-4.1-20250514-v1:0-with-thinking": ModelCapabilities(
            provider=ProviderType.DIAL,
            model_name="anthropic.claude-opus-4.1-20250514-v1:0-with-thinking",
