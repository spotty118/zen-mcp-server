...
class TestDIALProvider:
    ...
    def test_model_validation(self):
        ...
        assert provider.validate_model_name("anthropic.claude-opus-4.1-20250514-v1:0") is True
    ...
    def test_resolve_model_name(self):
        ...
        assert provider._resolve_model_name("opus-4.1") == "anthropic.claude-opus-4.1-20250514-v1:0"
        ...
        assert (
            provider._resolve_model_name("anthropic.claude-opus-4.1-20250514-v1:0")
    ...
    def test_get_capabilities(self):
        ...
        assert capabilities.model_name == "anthropic.claude-opus-4.1-20250514-v1:0"
        assert capabilities.context_window == 200_000
        assert capabilities.supports_images is True
        assert capabilities.supports_extended_thinking is False
        ...
        assert capabilities.model_name == "anthropic.claude-opus-4.1-20250514-v1:0-with-thinking"
        assert capabilities.context_window == 200_000
        assert capabilities.supports_images is True
    ...
    def test_supports_vision(self):
        ...
        assert provider._supports_vision("anthropic.claude-opus-4.1-20250514-v1:0") is True
    ...
    @patch.dict(os.environ, {"DIAL_ALLOWED_MODELS": "o3-2025-04-16,anthropic.claude-opus-4.1-20250514-v1:0"})
    @patch("utils.model_restrictions._restriction_service", None)
    def test_allowed_models_restriction(self):
        ...
        assert provider.validate_model_name("anthropic.claude-opus-4.1-20250514-v1:0") is True
        assert provider.validate_model_name("opus-4.1") is True  # Resolves to anthropic.claude-opus-4.1-20250514-v1:0
